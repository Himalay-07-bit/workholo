// biome-ignore-all lint/performance/noJsxPropsBind: This login form intentionally uses local state handlers.
							...
							<div className="space-y-5">
								...
								<div className="space-y-2">
									...
									<div className="group relative">
										...
										<Input
											className="h-12 rounded-lg border-slate-200 bg-white pr-11 pl-10 text-slate-900 text-xs shadow-none transition-all placeholder:text-slate-400 focus-visible:border-[#0757ff] focus-visible:ring-4 focus-visible:ring-blue-500/10"
											id="password"
